...
function sendOrderToGoogleSheets(name, email, orders, total) {
    const url = 'https://script.google.com/macros/s/AKfycbyUgTtMyzux_U8FDRYOFsqqZTsSnVr6djvwlMtVT4eSWtGdUpTtwI4pC3j5-RtUIQCP/exec';  // Replace with your Google Web App URL
